const CACHE_NAME = 'gnk-asg-live-v20-globe-insights';
const STATIC_ASSETS = [
  ...
  './assets/group-location-insights.css', './assets/command-centre.css',
  ...
  './assets/network-motion.js', './assets/group-globe-3d.js', './assets/group-location-insights.js',
  './assets/network-selection-sync.js', './assets/command-centre.js', './assets/network-search-3d.js',
  './assets/group-clarity.js', './assets/public-sources.js', './assets/hourly-data-disclosure.js',
  './assets/admin-status-only.js', './assets/market-centre-data.js', './assets/market-constellation.js',
  './data/desk_public_config.json', './data/group_network.json', './data/group_network_geo.json', './data/group_location_facts.json',
