...
def create_image_svg(raw_title: str, category: str, slot_label: str, slug: str) -> tuple[str, str, str, str]:
    ...
    image_alt = f"{raw_title} – vizual GNK ASG"
...
<title id="title">{safe_title} — GNK ASG</title>
<desc id="desc">Indeksabilna naslovna slika za autorsku dnevnu objavu GNK ASG Intelligence Desk. Urednička odgovornost: Nermin Sefić. GNK ASG d.o.o. i GNK DINAMO Ltd. Tema: {safe_category}.</desc>
...
<rect y="574" width="1200" height="56" fill="#05101f" opacity=".92"/><text x="64" y="610" font-family="Arial,sans-serif" font-size="20" fill="#dbe7f5">GNK ASG Intelligence Desk • Urednička odgovornost: Nermin Sefić • GNK ASG d.o.o. • GNK DINAMO Ltd.</text>
</svg>'''
    image_path.write_text(svg, encoding="utf-8")
    return image_url, image_src, image_alt, f"Vizualna interpretacija dnevne teme: {raw_title}."
