document.addEventListener('DOMContentLoaded', function () {
  'use strict';
  var VERSION = '20260613-front-same-globe-full-01';
  ...
  script('/assets/market.js'); script('/assets/world-geography.js'); script('/assets/group-network.js'); script('/assets/network-motion.js'); script('/assets/group-globe-3d.js'); script('/assets/globe-features-loader.js');
