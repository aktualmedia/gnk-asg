(() => {
  ...
  function labels() {
    return isEnglish() ? {
      business:'Business', finance:'Financials', network:'Global Network', technology:'Technology & AI', markets:'Markets', news:'News', desk:'Intelligence Desk', registers:'Public Registers', documents:'Documents', install:'Install app', control:'Control'
    } : {
      business:'Poslovno', finance:'Financije', network:'Globalna mreža', technology:'Tehnologija i AI', markets:'Tržišta', news:'Vijesti', desk:'Intelligence Desk', registers:'Javni registri', documents:'Dokumenti', install:'Instaliraj aplikaciju', control:'Upravljanje'
    };
  }
  ...
  function renderMenu() {
    try {
      ...
      const t = labels();
      mobile.innerHTML = '<a class="primary" href="/business/">' + t.business + '</a>' +
        '<a href="#assistant">' + t.desk + '</a>' +
