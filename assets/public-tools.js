...
function start(){addCss('/assets/site-share.css');addCss('/assets/floating-intelligence.css');addScript('/assets/site-share.js');addScript('/assets/floating-intelligence.js');watchDesk();}
