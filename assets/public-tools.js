...
var version='20260527-asg-bpp-share-unique03';
...
function start(){normalizeDataFetch();addCss('/assets/site-share.css');addCss('/assets/floating-intelligence.css');addCss('/assets/bpp-public-card.css');addScript('/assets/site-share.js');addScript('/assets/content-share.js');addScript('/assets/share-routing-fix.js');addScript('/assets/floating-intelligence.js');addScript('/assets/bpp-public-card.js');watchDesk();}
