...
var version='20260527-asg-bpp-share01';
...
function start(){normalizeDataFetch();addCss('/assets/site-share.css');addCss('/assets/floating-intelligence.css');addCss('/assets/bpp-public-card.css');addScript('/assets/site-share.js');addScript('/assets/content-share.js');addScript('/assets/floating-intelligence.js');addScript('/assets/bpp-public-card.js');watchDesk();}
